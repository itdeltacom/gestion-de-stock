            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="saleForm">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-3">
                                <label for="type" class="form-label">Type de Document <span
                            ...
                            <div class="col-md-3">
                                <label for="customer_id" class="form-label">Client <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-3">
                                <label for="warehouse_id" class="form-label">Entrepôt <span
                                        class="text-danger">*</span></label>
                        ...
                        <div id="credit_schedule_section" class="row mb-4" style="display: none;">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    <h6 class="alert-heading"><i class="fas fa-calendar-alt"></i> Échéancier de Paiement
                                    </h6>
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <label for="number_of_installments" class="form-label">Nombre
                                                d'Échéances</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <button type="button" class="btn btn-primary mb-0" id="add_product_btn" disabled>
