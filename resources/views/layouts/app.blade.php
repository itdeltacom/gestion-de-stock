        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body pt-sm-3 pt-0 overflow-auto">
                ...
                <div class="mt-3">
                    ...
                    <p class="text-sm">Choisissez entre 2 types différents.</p>
                </div>
                <div class="d-flex">
                ...
                <p class="text-sm d-xl-none d-block mt-2">Vous pouvez changer le type de sidenav uniquement sur
                    ordinateur.</p>
                <!-- Navbar Fixed -->
