            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        <div>
                            <h6 class="mb-0">
                                <i class="fas fa-shopping-cart me-2"></i>Créer un Nouvel Achat
                            </h6>
                            <p class="text-sm text-secondary mb-0">
                                Enregistrez un nouvel achat auprès d'un fournisseur
                            </p>
                        </div>
                        <div class="ms-auto">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="note" name="note" rows="2"
                                        placeholder="Notes ou remarques supplémentaires sur cet achat..."></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center">
                                    <small class="text-muted">
                                        ...
                                        L'achat sera enregistré avec le statut "En attente"
                                    </small>
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="submit" class="btn btn-primary" id="submitBtn">
                                            ...
                                            <span id="submitBtnText">Enregistrer l'Achat</span>
...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            function addProductRow(productId, productCode, productName, productPrice, productTva) {
                const row = `
                        <tr class="product-row" data-index="${productIndex}">
                            ...
                            <td>
                                <input type="number" class="form-control form-control-sm text-center quantity-input" 
                                    value="1" min="1" data-index="${productIndex}">
                            </td>
                            <td>
